...
[![Members](https://img.shields.io/badge/群成员-900+-4CAF50)](https://qm.qq.com/q/KQZsl4wFmG)
  ...
  <tr>
    <td width="50%" valign="top" style="padding: 0;">
      <table>
        ...
        <tr><td><strong>群成员</strong></td><td>900+ MPV</td></tr>
...
| 显示器 HDR | 视频类型 | 视频与显示器状态是否匹配 | 脚本动作 |
|:---:|:---:|:---:|:---|
| 开启 | HDR | ✅ | 不动 |
